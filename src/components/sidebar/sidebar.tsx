...
const SidebarMenuItem = ({ text, href, icon }: SidebarMenuItemProps) => {
  return (
    <>
      <NavLink href={href}>
        {({ isActive }) => (
...
const Sidebar = () => {
  return (
    <Box
      ...
      bg="gray.100"
    >
      <Box p="4" mb="2" display="flex" alignItems="center" gap="2">
        <Link href="/">
          <h1 className="text-xl md:text-xl leading-normal cursor-pointer font-extrabold text-gray-700">
            Moth<span className="text-blue-600">light</span>
          </h1>
        </Link>
